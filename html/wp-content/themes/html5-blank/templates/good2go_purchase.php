  ...
  <script>
    ...
    $(function(){   
      ...
      function postSteps(){
        ...
        var apiHostname = location.hostname == "www.hdev.online" ? "54.164.153.181" : "localhost";
        
        $.post("http://" + apiHostname + ":3000/chrome/g2gquote/" + window.step, $("#g2gPolicy").serialize(), function(data){
